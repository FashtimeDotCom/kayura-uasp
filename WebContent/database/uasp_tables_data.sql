...
alter table UASP_DictData add constraint FK_UASP_DictData_Parent_Ref_ID foreign key (Parent_Id)
...
alter table USAP_Dict add constraint FK_UASP_Dict_Ref_Tenant foreign key (Tenant_Id)
      references UASP_Tenants (Tenant_Id) on delete cascade on update restrict;
