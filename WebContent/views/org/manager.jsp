	...
	<k:layout id="ctx" fit="true">
		...
		<k:dock region="center" border="false">
			...
			<div id="tb">
				...
				<k:linkbutton id="tbaddemployee" onClick="jctx.addEmployee()" disabled="true" iconCls="icon-user" plain="true" text="添加员工" />
			...
			<div id="mm" class="easyui-menu" style="width: 120px;">
				...
				<div id="mmaddemployee" onclick="jctx.addEmployee()" data-options="iconCls:'icon-user'">添加员工</div>
