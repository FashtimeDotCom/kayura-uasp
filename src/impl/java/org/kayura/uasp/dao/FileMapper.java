...
public interface FileMapper extends BaseDao {
	 ...
	 * 
	 * @param args
	 *            支持条件有: fileId (文件Id), bizId (关联业务Id), category (分类), uploader
	 *            (上传者), tags (标签）
	 * @return 返回所有符件条件的记录
	 */
	 ...
	 * 
	 * @param args
	 *            sharerId 共享者Id, receiverId 接收者Id, findType 查找类型:FOLDER 文件夹,
	 *            FILE 文件, null 查全部..
